...
import formimage from "../../images/MYjp.gif"
const Formmissing = () => {
      ...
      <form method="POST">
        <div className="user-details">
          ...
          <div className="input-box">
            ...
            <input type="date" placeholder="Enter mising date of a person" name="datemissing" value={user.datemissing} onChange={handleinput} required/>
          </div>
          <div className="input-box">
